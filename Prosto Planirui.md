...
* Реализация интерефейса для удаления выполненной пользователем задачи из общего списка задач

*	Реализация интерфейса переключения между месяцами и датами 

*	Реализация отображения таблицы с датами.

*	Реализация интерфейса добавления события на текущую дату с указанием заголовка события а так же текстовой части или описания события.
